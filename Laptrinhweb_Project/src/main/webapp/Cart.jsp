                        ...
                        <div class="row py-5 p-4 bg-white rounded shadow-sm">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="p-4">
                                    ...
                                    <c:set var="roundTotalToPay" value="${fn:replace(roundTotalToPay, ',', '.')}" />
                                    <a href="order?action=add&totalPrice=${roundTotalToPay}" class="btn btn-dark rounded-pill py-2 btn-block">Mua hàng</a>
