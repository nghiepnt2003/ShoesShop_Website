...
<body>
<div id="logreg-forms">
    <form class="form-forget" action="forgetpass" method="post">
        ...
        <input name="otp" type="text" style="margin-top: 4px" id="otpInput" placeholder="EnterOTP"   required autofocus>
        <button type="button" style="border-radius: 4px;border: 1px solid #777" onclick="sendOtpCheckPass()">Send OTP</button>


        <button class="btn btn-success btn-block" type="submit"><i class="fas fa-sign-in-alt"></i> Confirm</button>
        <hr>
    </form>
